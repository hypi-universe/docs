module.exports = {
  docs: [
      ...
      },
      {
       type: 'category',
       label: 'Widgets',
       items: ['widget-column','widget-container','widget-row','widget-icon','widget-icon-button','widget-text','widget-text-field','widget-action-chip','widget-back-button','widget-close-button','widget-elevated-button','widget-outlined-button','widget-text-button','widget-about-dialog','widget-aspect-ratio','widget-card','widget-center','widget-circle-avatar','widget-clip-oval','widget-clip-rrect','widget-colored-box','widget-constrained-box','widget-dialog','widget-divider','widget-expand-icon','widget-expanded','widget-fitted-box','widget-flex','widget-flutter-logo','widget-fractionally-sized-box','widget-grid-paper','widget-grid-tile','widget-grid-tile-bar','widget-vertical-divider'],
      },
      {
       type: 'category',
